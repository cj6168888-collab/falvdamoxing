...
> 核心理念：用户只陈述事实，AI 吃透全部证据后给出专业建议，确认后自动填入案件
...
| 2 | AI 先吃透全部证据 | 回答任何问题前，必须完整阅读案件所有证据 |
| 3 | AI 主动给建议 | 可主张什么权利、主张多少金额、被告底线在哪 |
| 4 | 用户确认后自动填入 | 点"认可"后，金额/案由等自动更新到案件 |
| 5 | 多轮对话有上下文 | 说"重新回答"时 AI 知道之前聊了什么 |
| 6 | 推荐文书可点击生成 | AI 分析后推荐文书，点击直接生成 |
| 7 | 分析结果可导出 | PDF/Word/完整对话记录 导出按钮始终可见 |
| 8 | 排版美观 | 表格、标题、重点高亮，无乱码符号 |
| 9 | AI 展示已读证据清单 | 让用户知道 AI 到底看了哪些证据 |
...
| 15 | 一键生成全套文书 | AI 推荐多份文书时，可一键全部生成 |
